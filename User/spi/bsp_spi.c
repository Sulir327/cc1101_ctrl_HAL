...
void GPIO_Config(void)
{
    ...
    //配置LED3的GPIO引脚
    GPIO_InitStructure.Pin = LED3_Orange_PIN;
    ...
    //配置LED4的GPIO引脚
    GPIO_InitStructure.Pin = LED4_Green_PIN;
    HAL_GPIO_Init(LED_GPIO_PORT, &GPIO_InitStructure);

    //配置LED5的GPIO引脚
    GPIO_InitStructure.Pin = LED5_Red_PIN;
    HAL_GPIO_Init(LED_GPIO_PORT, &GPIO_InitStructure);
    
    //配置LED6的GPIO引脚
    GPIO_InitStructure.Pin = LED6_Blue_PIN;
    HAL_GPIO_Init(LED_GPIO_PORT, &GPIO_InitStructure);
...
void SPI_Config(void)
{
    ...
    SpiHandle.Init.BaudRatePrescaler 	= SPI_BAUDRATEPRESCALER_256;//84MHz/32 = 3.625MHz
